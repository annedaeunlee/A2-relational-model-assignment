...
CREATE TABLE `heading` (
  ...
  PRIMARY KEY (`id`),
  KEY `heading_widget_generalization_idx` (`widget_id`),
  CONSTRAINT `heading_widget_generalization` FOREIGN KEY (`widget_id`) REFERENCES `widget` (`id`)
...
-- Dump completed on 2020-10-19 22:12:17
